...
void YearComparison_check_ele_2018(TString reconstruction){
...
//     TString reconstruction = "madgraph";
	...
	for(int mu = 0; mu < 2; mu++){
		...
		for(int year = 0; year < 2; year++){
			...
			if(year == 0){
			    if(muon) infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_2018_1025_check_m2mu_2018.root");                                                                               
        	    else infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_2018_1025_check_m2e_2018.root");                                                                                          
	        }		
	        else if(year == 1){                                                                                                                 
			    if(muon) infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/madgraph/DYJetsToLL_M-50_Full_RunII_madgraph_m2mu_2018.root");                                                                                  
        	    else infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/madgraph/DYJetsToLL_M-50_Full_RunII_madgraph_m2e_2018.root");                                                                                                                                         
			}
			else{
...
// 	return;
		...
		if(mu == 0){
			...
			legend_year->AddEntry(histograms[0][1][0], "2018_1025");
			legend_year->AddEntry(histograms[0][1][1], "2017_10215");
		}

	
// 		directory = "./PlotYearComparison_pTerr_0p5_1p5_" + reconstruction;;
// 		directory = "./PlotYearComparison_pTerr_below0p5_" + reconstruction;;
		directory = "./PlotYearComparison_checkEle" + reconstruction;;
...
// 	ratio->GetYaxis()->SetTitleFont(43);
	...
	ratio_2017->GetYaxis()->SetTitle("2017_10215 / 2017_1025");//Reco / Gen");
