...
void YearComparison_check_ele(TString reconstruction){
...
// 	eta_bins.push_back(0.1);
// 	eta_bins.push_back(0.2);
// 	eta_bins.push_back(0.3);
// 	eta_bins.push_back(0.4);
// 	eta_bins.push_back(0.5);
// 	eta_bins.push_back(0.6);
// 	eta_bins.push_back(0.7);
// 	eta_bins.push_back(0.8);
	eta_bins.push_back(0.9);
	eta_bins.push_back(1.0);
	eta_bins.push_back(1.1);
	eta_bins.push_back(1.2);
	eta_bins.push_back(1.3);
	eta_bins.push_back(1.5);
	eta_bins.push_back(1.7);
	eta_bins.push_back(1.8);
	eta_bins.push_back(1.9);
	eta_bins.push_back(2.0);
	eta_bins.push_back(2.1);
	eta_bins.push_back(2.2);
	eta_bins.push_back(2.3);
	eta_bins.push_back(2.5);
	
	std::vector<TString> eta_bins_name;
// 	eta_bins_name.push_back("0");
// 	eta_bins_name.push_back("0p1");
// 	eta_bins_name.push_back("0p2");
// 	eta_bins_name.push_back("0p3");
// 	eta_bins_name.push_back("0p4");
// 	eta_bins_name.push_back("0p5");
// 	eta_bins_name.push_back("0p6");
// 	eta_bins_name.push_back("0p7");
// 	eta_bins_name.push_back("0p8");
	eta_bins_name.push_back("0p9");
	eta_bins_name.push_back("1p0");
	eta_bins_name.push_back("1p1");
	eta_bins_name.push_back("1p2");
	eta_bins_name.push_back("1p3");
	eta_bins_name.push_back("1p5");
	eta_bins_name.push_back("1p7");
	eta_bins_name.push_back("1p8");
	eta_bins_name.push_back("1p9");
	eta_bins_name.push_back("2p0");
	eta_bins_name.push_back("2p1");
	eta_bins_name.push_back("2p2");
	eta_bins_name.push_back("2p3");
	eta_bins_name.push_back("2p5");	
	
	TH1F* h_histo_pterr1old_vs_eta_below[eta_bins.size()][3];
	TH1F* h_histo_pterr1old_vs_eta_above[eta_bins.size()][3];
	TH1F* h_histo_pterr2old_vs_eta_below[eta_bins.size()][3];
	TH1F* h_histo_pterr2old_vs_eta_above[eta_bins.size()][3];
	TH1F* h_histo_eta1_below[eta_bins.size()];
	TH1F* h_histo_eta1_above[eta_bins.size()];
	TH1F* h_histo_eta2_below[eta_bins.size()];
	TH1F* h_histo_eta2_above[eta_bins.size()];

	for(int y = 0; y < 2; y++){
		for(int i = 0; i < eta_bins.size(); i++){
			if(y == 0){
				h_histo_eta1_below[i] = new TH1F("h_histo_eta1_below_" + eta_bins_name.at(i), "h_histo_eta1_below_" + eta_bins_name.at(i), 48, -2.4, 2.4);
				h_histo_eta1_above[i] = new TH1F("h_histo_eta1_above_" + eta_bins_name.at(i), "h_histo_eta1_above_" + eta_bins_name.at(i), 48, -2.4, 2.4);
				h_histo_eta2_below[i] = new TH1F("h_histo_eta2_below_" + eta_bins_name.at(i), "h_histo_eta2_below_" + eta_bins_name.at(i), 48, -2.4, 2.4);
				h_histo_eta2_above[i] = new TH1F("h_histo_eta2_above_" + eta_bins_name.at(i), "h_histo_eta2_above_" + eta_bins_name.at(i), 48, -2.4, 2.4);
			}
			h_histo_pterr1old_vs_eta_below[i][y] = new TH1F("h_histo_pterr1old_vs_eta_below_" + eta_bins_name.at(i)+ years[y], "h_histo_pterr1old_vs_eta_below_" + eta_bins_name.at(i)+ years[y], 100, 0, 10);
			h_histo_pterr1old_vs_eta_above[i][y] = new TH1F("h_histo_pterr1old_vs_eta_above_" + eta_bins_name.at(i)+ years[y], "h_histo_pterr1old_vs_eta_above_" + eta_bins_name.at(i)+ years[y], 100, 0, 10);	
			h_histo_pterr2old_vs_eta_below[i][y] = new TH1F("h_histo_pterr2old_vs_eta_below_" + eta_bins_name.at(i)+ years[y], "h_histo_pterr2old_vs_eta_below_" + eta_bins_name.at(i)+ years[y], 100, 0, 10);
			h_histo_pterr2old_vs_eta_above[i][y] = new TH1F("h_histo_pterr2old_vs_eta_above_" + eta_bins_name.at(i)+ years[y], "h_histo_pterr2old_vs_eta_above_" + eta_bins_name.at(i)+ years[y], 100, 0, 10);	
		}
	}
	...
	for(int mu = 1; mu < 2; mu++){
		...
		for(int year = 0; year < 2; year++){
			...
			if(year == 0){
			    ...
			    if(muon) infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m2mu_2018.root");                                                                                                      else infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/amcatnlo/DYJetsToLL_M-50_Full_RunII_amcatnlo_m2e_2017.root");                                                                                                                                         
	        }
...
// 						DeltaPt_vs_pT_1p8_2p4[0][year]->Fill(pT2, pterr2/pT2);//, weight);
					...
					if(lep1_ecalDriven){
						for(int i = 0; i < eta_bins.size(); i++){
							if(fabs(eta1) < eta_bins.at(i)){
								h_histo_pterr1old_vs_eta_below[i][year]->Fill(pterr1old);
								h_histo_eta1_below[i]->Fill(eta1);
							}
							else{
								h_histo_pterr1old_vs_eta_above[i][year]->Fill(pterr1old);						
								h_histo_eta1_above[i]->Fill(eta1);
							}
						}														
					}
					...
					if(lep2_ecalDriven){
						for(int i = 0; i < eta_bins.size(); i++){
							if(fabs(eta2) < eta_bins.at(i)){
								h_histo_pterr2old_vs_eta_below[i][year]->Fill(pterr2old);
								h_histo_eta2_below[i]->Fill(eta2);
							}
							else{
								h_histo_pterr2old_vs_eta_above[i][year]->Fill(pterr2old);
								h_histo_eta2_above[i]->Fill(eta2);
							}						
						}														
					}
...
// 	return;
		...
		if(mu == 0){
            ...
            legend_year->AddEntry(histograms[0][1][1], "2017_1025_NoScale");
			legend_year->AddEntry(histograms[0][1][2], "2017_1025");
		}

	
// 		directory = "./PlotYearComparison_pTerr_0p5_1p5_" + reconstruction;;
// 		directory = "./PlotYearComparison_pTerr_below0p5_" + reconstruction;;
		directory = "./PlotYearComparison_checkEle_NoScale" + reconstruction;;
...
// 		Draw_TH2F(DeltaPt_vs_pT_1p8_2p4[0][0], DeltaPt_vs_pT_1p8_2p4[0][2], "DeltaPt_vs_pT_1p8_2p4_2016_2018", directory + save_nome + ".pdf", legend_year);
		...
		save_nome = "YearComparison_ptErrOld1_below_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "pterr1_below_" + eta_bins_name.at(i);
			Draw(h_histo_pterr1old_vs_eta_below[i][0], h_histo_pterr1old_vs_eta_below[i][1], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);

		save_nome = "YearComparison_ptErrOld2_below_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "pterr2_below_" + eta_bins_name.at(i);
			Draw(h_histo_pterr2old_vs_eta_below[i][0], h_histo_pterr2old_vs_eta_below[i][1], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);

		save_nome = "YearComparison_ptErrOld1_above_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "pterr1_above_" + eta_bins_name.at(i);
			Draw(h_histo_pterr1old_vs_eta_above[i][0], h_histo_pterr1old_vs_eta_above[i][1], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);

		save_nome = "YearComparison_ptErrOld2_above_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "pterr2_above_" + eta_bins_name.at(i);
			Draw(h_histo_pterr2old_vs_eta_above[i][0], h_histo_pterr2old_vs_eta_above[i][1], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);
		...
		save_nome = "YearComparison_eta1_below_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "eta1_below_" + eta_bins_name.at(i);
			Draw(h_histo_eta1_below[i], h_histo_eta1_below[i], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);

		save_nome = "YearComparison_eta1_above_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "eta1_above_" + eta_bins_name.at(i);
			Draw(h_histo_eta1_above[i], h_histo_eta1_above[i], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);

		save_nome = "YearComparison_eta2_below_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "eta2_below_" + eta_bins_name.at(i);
			Draw(h_histo_eta2_below[i], h_histo_eta2_below[i], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);

		save_nome = "YearComparison_eta2_above_" + fs;	
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf[", legend_reco_gen);
		for(int i = 0; i < eta_bins.size(); i++){
			TString nome_canvas = "eta2_above_" + eta_bins_name.at(i);
			Draw(h_histo_eta2_above[i], h_histo_eta2_above[i], nome_canvas, directory + save_nome + ".pdf", legend_year);
		}
		Draw(h_blank, h_blank, "h_blank", directory + save_nome + ".pdf]", legend_reco_gen);
