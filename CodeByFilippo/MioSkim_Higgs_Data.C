...
void MioSkim_Higgs_Data(TString fs, TString year, TString run){
...
//   newtree->Branch("etaj2",&etaj2,"etaj2/D");
    ...
    TFile* newfile =  new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII//Data_4l/" + year + "/" + name + ".root","RECREATE");                                                                                                                             
