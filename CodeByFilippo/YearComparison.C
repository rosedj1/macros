...
void YearComparison(TString reconstruction){
...
//     TString reconstruction = "madgraph";
	...
	for(int mu = 0; mu < 2; mu++){
		...
		for(int year = 0; year < 3; year++){
			...
			if(year == 0){
			    if(muon) infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m2mu_2016.root");                                                                                                                                         
        	    else infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m2e_2016.root");                                                                                                                                         

	        }		
	        else if(year == 1){                                                                                                                      
			    if(muon) infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m2mu_2017.root");                                                                                                                                         
        	    else infile = new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m2e_2017.root");                                                                                                                                         
			}
			else{
...
// 		directory = "./PlotYearComparison_pTerr_below0p5_" + reconstruction;;
		directory = "./PlotYearComparison_" + reconstruction;;
