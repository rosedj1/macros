...
void MioSkim_Data_d0(TString fs, TString year, TString run, bool max_entry, int set_low, int set_max, TString subname){
...
// 
  ...
  if(fs == "2mu")
	//infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/Data/" + year + "/Muon/SingleMuon_" + run + ".root";
    infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/d0Studies/Data/" + year + "/Muon/SingleMuon_" + run + ".root";
  else{
  	if(year == "2018")
  		//infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/Data/" + year + "/Electron/EGamma_" + run + ".root";
        infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/d0Studies/Data/" + year + "/Electron/EGamma_" + run + ".root";
  	else if(year == "2016" || year == "2017")	
  		infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/d0Studies/Data/" + year + "/Electron/SingleElectron_" + run + ".root";
        //infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/Data/" + year + "/Electron/SingleElectron_" + run + ".root";
  	else{
  ...
  TFile* tmpFile =  new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/d0studies/Data/" + year + "/" + name + subname + ".root","RECREATE");
