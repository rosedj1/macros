...
TTree* tree_MU;                                               
TTree* tree_ELE;  
TString infile_MU_name;
TString infile_ELE_name;                                             
...
void TwoDMap_Data_v2(TString reconstruction, TString run) {
...
// 	year_name.push_back("2018");
	...
	for(int year = 0; year < 3; year++){
		...
		if(year == 0){
			infile_MU_name = "/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/Data/2016/Data_m2mu" + run + ".root";
			infile_ELE_name = "/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/Data/2016/Data_m2e" + run + ".root";
			year_name = "2016";
		}
		else if(year == 1){
			infile_MU_name = "/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/Data/2017/Data_m2mu" + run + ".root";
			infile_ELE_name = "/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/Data/2017/Data_m2e" + run + ".root";
			year_name = "2017";
		}
		else{
            infile_MU_name = "/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/Data/2018/Data_m2mu" + run + ".root";
            infile_ELE_name = "/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/Data/2018/Data_m2e" + run + ".root";
            year_name = "2018";
		}	        

    infile_MU = new TFile(infile_MU_name);
    infile_ELE = new TFile(infile_ELE_name);
	...
	ErrPt_vs_pt_2_25_TRACKER[year] =new TH2F("ErrPt_vs_pt_2_25_TRACKER_" + year_name, "ErrPt_vs_pt_2_25_TRACKER_" + year_name, 100, 0.0, 100, 100, 0.0, 0.1);
		...
		std::cout<<infile_MU_name<<std::endl;	
		std::cout<<infile_ELE_name<<std::endl;
...
// 			h_0_09->Fill(eta2);
			...
			else if(fabs(eta1) > 0.9 && fabs(eta2) > 0.9 && 
					fabs(eta1) < 1.8 && fabs(eta2) < 1.8){
			...
			else if(fabs(eta1) > 1.8 && fabs(eta2) > 1.8 && 
				fabs(eta1) < 2.4 && fabs(eta2) < 2.4){
