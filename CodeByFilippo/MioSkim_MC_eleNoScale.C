...
// 
  ...
  TString infilename;
  infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/Electron_NoScale.root"; 
  ...
  TFile* tmpFile =  new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/DYJetsToLL_M-50_Full_RunII_amcatnlo_2017_ElecNoScale.root","RECREATE");
...
//         return;
        ...
        for(int mcfmEvt_HZZ = 0; mcfmEvt_HZZ < nentries; mcfmEvt_HZZ++) { //event loop
