...
void MioSkim_MC_d0(TString fs, TString year, TString reconstruction, bool max_entry, int set_low, int set_max, TString subname){
...
// 
  ...
  float_t massZ1_vtx = 0; 
  float_t massErrZ1_vtx = 0;
  float_t massZ1_vtx_chi2 = 0;
  ...
  float massZ_vtx, massErrZ_vtx, massZ_vtx_chi2;
  double Iso1, Iso2;
  double d0BS1, d0BS2;
  double d0PV1, d0PV2;
  int Id1, Id2;
  ...
  infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/Full_RunII/Ymeson/Ymeson_" + year + "_2mu.root";
  //infilename = "../../../HZZ4l_Run2_d0/CMSSW_10_2_15/src//DUMMYFILENAME_Y_2017.root";
  ...
  TFile* tmpFile =  new TFile(
          "Ymeson_" + year + "_2mu.root"
          ,"RECREATE");
//  "/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/d0studies/DY/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m" + fs + "_" + year + subname + ".root","RECREATE");
  ...
  //newtree->Branch("massZ_vtx_chi2",&massZ_vtx_chi2,"massZ_vtx_chi2/D"); 
...
// 
        ...
        //tree->SetBranchAddress("massZ1_vtx",1);
        //tree->SetBranchAddress("massErrZ1_vtx", 1);
        //tree->SetBranchAddress("massZ1_vtx_chi2",1);
...
//            lep2p.SetPtEtaPhiM(double((*lep_pt)[L2]+pterr2old),double((*lep_eta)[L2]),double((*lep_phi)[L2]),double((*lep_mass)[L2]));
            ...
            //massZ_vtx = massZ1_vtx;
            //massErrZ_vtx = massErrZ1_vtx;
            //massZ_vtx_chi2 = massZ1_vtx_chi2;
