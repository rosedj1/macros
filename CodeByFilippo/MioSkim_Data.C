...
void MioSkim_Data(TString fs, TString year, TString run, bool max_entry, int set_low, int set_max, TString subname){
...
// 
  ...
  TFile* tmpFile =  new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/Data/" + year + "/" + name + subname + ".root","RECREATE");
