...
// 
  ...
  //infilename = "root://cmsio5.rc.ufl.edu//store/user/t2/users/ferrico/2018_Rochester_madgraph_1025.root";//2017_Rochester_check.root"; 
  //infilename = "../../../HZZ4l_Run2_d0/CMSSW_10_2_15/src//DUMMYFILENAME.root";
  ...
  //TFile* tmpFile =  new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m" + fs + "_" + year + subname + ".root","RECREATE");
     ...
     TFile* tmpFile =  new TFile("/raid/raid8/ferrico/Useful_Code_HZZ/CMSSW_10_2_15/src/Full_RunII/" + reconstruction + "/DYJetsToLL_M-50_Full_RunII_" + reconstruction + "_m" + fs + "_" + year + subname + "_v2.root","RECREATE");                                                              
