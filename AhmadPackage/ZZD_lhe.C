...
// define input
    ...
    TT->Branch("phi3",&phi3,"phi3/D");
    TT->Branch("phi4",&phi4,"phi4/D");
    TT->Branch("phi5",&phi5,"phi5/D");
    TT->Branch("phi6",&phi6,"phi6/D");
    ...
    while (1) {
        ...
        if ( (sumAbsId!=44 && sumAbsId!=48 && sumAbsId!=52) || (sumAbsId==52 && (fabs(id1)==15 || fabs(id2)==15 || fabs(id3)==15 || fabs(id4)==15)) ) {
            ...
            // other observables
            pt3 = L11P4.Pt(); eta3 = L11P4.Eta(); phi3 = L11P4.Phi();
            pt4 = L12P4.Pt(); eta4 = L12P4.Eta(); phi4 = L12P4.Phi();
            pt5 = L21P4.Pt(); eta5 = L21P4.Eta(); phi5 = L21P4.Phi();
            pt6 = L22P4.Pt(); eta6 = L22P4.Eta(); phi6 = L22P4.Phi();
            ...
            if ( (!bApplyCuts) || ( (pto1>20.0 && pto2>10.0 && pto3>5.0 && pto4>5.0) 
                ...
                // Fill the tree
                // IS IT REALLY THIS EASY TO JUST FILL THE ENTIRE TREE???
                TT->Fill();
